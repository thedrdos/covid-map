...
output_filename = "./tmp_data/site/plots/"+os.path.basename(os.path.splitext(__file__)[0]) # name the output file/s after the script file
...
ext_datafiles = {}
ext_datafiles['path'] = "./tmp_data/site/plots/data/" 
...
init_location = 'Ohio, US' # get first key, i.e. state name
